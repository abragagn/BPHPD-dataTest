...
void fitBsMc16(TString fileName = "ntuMC2016.root"){
    ...
    for(int i=0; i<cuts.size(); ++i){
        ...
        TString name = "mcBsJpsiPhi/bsMass_" + cuts[i].second + "_" + "mc2016";
        TString nameCt = "mcBsJpsiPhi/bsCt_" + cuts[i].second + "_" + "mc2016";
        TCanvas c1;
